...
def dim_eight_pixels_image():
    ...
    for row in range(im.height):
        for col in range(im.width):
            ...
            g_new = g//2
            b_new = b//2
            im_dim.putpixel((col, row), (r_new, g_new, b_new))
...
def blue_washed_image():
    ...
    for row in range(im.height):
        for col in range(im.width):
            ...
            g_new = g
            b_new = 255
            im_blue.putpixel((col, row), (r_new, g_new, b_new))
...
# by the following 4 lines of code. How do you like it? 😄 it's strange
...
def decode_image():
    ...
    for row in range(im.height):
        for col in range(im.width):
            (r, g, b) = im.getpixel((col, row))
            if r % 2 == 1:
                im_secret.putpixel((col, row), (0, 0, 0))  # Set pixel to black
            else:
                im_secret.putpixel((col, row), (255, 0, 0))  # Set pixel to red
